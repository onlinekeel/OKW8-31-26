...
export function ProjectForm() {
  ...
  return (
    <form onSubmit={openDraft} className="rounded-[2rem] border border-[#0b2530]/12 bg-white p-6 shadow-[0_24px_70px_rgba(11,37,48,0.08)] sm:p-9">
      ...
      <p className="mt-4 max-w-lg text-xs leading-5 text-[#6b7b80]">This opens your email app with the details filled in. Nothing is submitted or stored on this page.</p>
    </form>
  );
}
